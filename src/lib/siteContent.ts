...
export const defaultAboutNashmiContent = {
  ...
  bodyAr: "نشمي منصة رقمية محايدة تعزز المشاركة المدنية وتسهّل الوصول إلى المعلومات الحزبية والانتخابية والتشريعية.",
  bodyEn: "Nashmi is a neutral digital platform that strengthens civic participation and makes party, electoral, and legislative information easier to access.",
