...
export default function FloatingAssistant() {
  return (
    <Link
      href="/chat"
      className="fixed bottom-5 left-5 z-30 inline-flex items-center gap-2 rounded-full bg-civic px-4 py-3 font-semibold text-white shadow-soft ring-1 ring-white/25 transition hover:bg-civic/90 active:scale-95"
