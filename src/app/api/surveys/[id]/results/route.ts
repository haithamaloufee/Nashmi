...
import { buildSurveyResultSummary, canManageSurvey, canViewSurveyResults, surveyIdentifierLookup } from "@/lib/surveys";
...
export async function GET(_request: Request, context: Context) {
  try {
    ...
    const survey = await Survey.findOne(lookup).lean();
